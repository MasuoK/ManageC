// ex3.cpp - 2次元ベクトル型(C++版)テストプログラム
//  作者: (あなたの名前); 日付:6/20 (完成した日付)
//
...
int main(int argc, char *argv[]) {
    ...
    std::cout << "a = " << a << std::endl; //演習3(1)初期値確認
    std::cout << "b = " << b << std::endl; //演習3(1)初期値確認
    std::cout << "t = " << t << std::endl; //演習3(1)初期値確認
